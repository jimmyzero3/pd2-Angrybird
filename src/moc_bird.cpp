...
const QMetaObject Bird::staticMetaObject = {
    { &GameItem::staticMetaObject, qt_meta_stringdata_Bird.data,
      qt_meta_data_Bird,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Bird::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Bird.stringdata0))
        return static_cast<void*>(const_cast< Bird*>(this));
